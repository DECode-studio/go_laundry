...
import 'package:go_laundry/pages/admin/detail/main.dart';
import 'package:go_laundry/pages/admin/home/fragments/widgets/confirm-modal.dart';
  ...
  return Column(
    children: [
      ...
      GestureDetector(
        onTap: () {
          orderConfirm
              ? Get().to(context, detailPage(orderId))
              : confirmModal(context, orderId, orderName, orderTime);
        },
        child: SizedBox(
          height: 106,
          child: Stack(
