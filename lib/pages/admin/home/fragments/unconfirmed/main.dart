...
class unconfirmedFragment extends StatefulWidget {
  unconfirmedFragment({Key? key}) : super(key: key);

  @override
  State<unconfirmedFragment> createState() => _unconfirmedFragmentState();
}

class _unconfirmedFragmentState extends State<unconfirmedFragment> {
                ...
                ? ListView(
                    ...
                    children: [
                      ...
                      for (var i = 0; i < streamSnapshot.data!.docs.length; i++)
                        streamSnapshot.data!.docs[i]['orderConfirm'] == false
                            ? cardOrder(
                                context,
